...
- [`calculadora-folha/`](calculadora-folha/) — calculadora web (um único
  arquivo HTML) de folha mensal, férias, 13º salário e rescisão, com INSS,
  IRRF (redutor da Lei 15.270/2025), FGTS, memória de cálculo e tabelas
  editáveis.
